...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"Arreglo De Números";
			// 
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(18, 41);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(211, 41);
			this->textBox2->Multiline = true;
			this->textBox2->Name = L"textBox2";
			this->textBox2->Size = System::Drawing::Size(109, 199);
			...
			this->button1->Text = L"Insertar al Final";
			...
			this->button2->Text = L"Insertal al Inicio";
			...
			this->button3->Text = L"Insertar en Posición";
			this->button3->UseVisualStyleBackColor = true;
			// 
			// button4
			// 
			this->button4->Location = System::Drawing::Point(12, 217);
			this->button4->Name = L"button4";
			this->button4->Size = System::Drawing::Size(159, 23);
			this->button4->TabIndex = 6;
			this->button4->Text = L"Eliminar Ocurrencias";
			...
			this->ClientSize = System::Drawing::Size(342, 296);
